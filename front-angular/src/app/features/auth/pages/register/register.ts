        ...
        <div class="auth-card">
          ...
          <form (ngSubmit)="onSubmit()">
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-input" [(ngModel)]="password" name="password" required minlength="6">
            </div>
            <div class="mb-3">
              <label class="form-label">Confirmar contraseña</label>
              <input type="password" class="form-input" [(ngModel)]="passwordConfirmation" name="passwordConfirmation" required>
            </div>
          ...
          <p class="mt-3 text-center">
            Ya tenes cuenta? <a routerLink="/auth/login">Ingresar</a>
          </p>
        </div>
      </div>
    </div>
